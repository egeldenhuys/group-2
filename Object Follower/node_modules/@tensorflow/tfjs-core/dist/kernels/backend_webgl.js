...
var MathBackendWebGL = (function () {
    ...
    MathBackendWebGL.prototype.batchMatMul = function (a, b, transposeA, transposeB) {
        ...
        if (batch === 1) {
            ...
            var result = this.compileAndRun(program, [aSqueezed, bSqueezed]);
    ...
    MathBackendWebGL.prototype.unpackTensor = function (input) {
        ...
        return this.compileAndRun(program, [input], tensor_1.Tensor.make(program.outputShape, {}));
    };
    ...
    MathBackendWebGL.prototype.compileAndRun = function (program, inputs, output, customSetup, pageToCpu) {
        ...
        if (output == null) {
            if (program.usesPackedTextures) {
                output = this.makePackedTensor(program.outputShape);
            }
            else {
        ...
        var inputsData = inputs.map(function (input) {
            ...
            if (texData.texture == null &&
                ...
                if (texData.isPacked) {
                    ...
                    processedInput = _this.compileAndRun(preProcessProgram, [input], tensor_1.Tensor.make(preProcessProgram.outputShape, {}));
                }
                else {
