                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (!this.fullColumnNames && !columnNamesFromFile) {
                            ...
                            util_1.assert(columnNamesFromFile.length === this.fullColumnNames.length, 'The length of provided columnNames (' +
                        ...
                        util_1.assert(duplicateNames.length === 0, 'Duplicate column names found: ' + duplicateNames.toString());
